...
class CarrierProfileUI extends StatelessWidget {
  final TextEditingController emailController;
  final TextEditingController nameController;
  final TextEditingController phoneController;
  final String selectedRole;

  const CarrierProfileUI({
    super.key,
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton(
            ...
            child: const Text('차주', style: TextStyle(color: AppColors.white)),
          ),
        ),
      ],
    );
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            padding: const EdgeInsets.only(top: 35, bottom: 70),  // 화주와 동일한 padding
            child: Column(
              children: [
                Stack(
                    ...
                    Positioned(
                      ...
                      child: Container(
                        decoration: const BoxDecoration(
                          ...
                          color: AppColors.primary,  // 화주와 동일 색상으로 통일
                        ),
