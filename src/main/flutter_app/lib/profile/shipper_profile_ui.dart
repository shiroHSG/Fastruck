    ...
    return Column(
      ...
      children: [
        Text(label, style: const TextStyle(
            color: AppColors.point, fontWeight: FontWeight.bold)),
                  ...
                  Stack(
                    ...
                    children: [
                      const CircleAvatar(
                        ...
                        child: Icon(
                            Icons.person, size: 50, color: AppColors.point),
                      ),
                      Positioned(
                        right: 1,
                        bottom: 4,
                        child: Container(
                          ...
                          child: const Icon(
                              Icons.camera_alt, size: 23, color: Colors.white),
                        ),
                      )
                    ],
                  ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('가입 유형', style: TextStyle(
                      color: AppColors.point, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 6),
                  _buildRoleButtons(),
